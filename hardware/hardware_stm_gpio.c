...
#define PORTA_MODER_REGISTER (PORTC_BASE_ADDRESS + 0x00) //replace the question mark with the correct offset!
#define PORTA_OTYPER_REGISTER (PORTC_BASE_ADDRESS + 0x04)
#define PORTA_OSPEEDR_REGISTER (PORTC_BASE_ADDRESS + 0x08)
#define PORTA_PUPDR_REGISTER (PORTC_BASE_ADDRESS + 0x0C)
#define PORTA_IDR_REGISTER (PORTC_BASE_ADDRESS + 0x10)
#define PORTA_ODR_REGISTER (PORTC_BASE_ADDRESS + 0x14)
#define PORTA_BSRRL_REGISTER (PORTC_BASE_ADDRESS + 0x18)
#define PORTA_BSRR_REGISTER (PORTC_BASE_ADDRESS + 0x18)
#define PORTA_BSRRH_REGISTER (PORTC_BASE_ADDRESS + 0x1A)
#define PORTA_LCKR_REGISTER (PORTC_BASE_ADDRESS + 0x1C)
#define PORTA_AFR1_REGISTER (PORTC_BASE_ADDRESS + 0x20)
#define PORTA_AFR2_REGISTER (PORTC_BASE_ADDRESS + 0x24)
